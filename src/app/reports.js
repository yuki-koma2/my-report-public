export const reports = [
  ...
  },
  {
    ...
    articleTypeLabel: "週次最新情報",
    cadence: "週次で自動更新・追加",
    tags: ["テック情勢", "AI", "エンジニアリング", "半導体", "セキュリティ", "開発者ツール", "規制", "スタートアップ"],
    summary:
      "2026年6月25日から2026年7月1日までに確認できた公開情報を中心に、AIエージェント、開発者ツール、AIインフラ、セキュリティ、規制、スタートアップ投資の変化を整理した週次レポートです。",
    publishedAt: "2026-07-01",
    checkedAt: "2026-07-01",
    sources: [
      {
    ...
    lead: {
      title: "今週の判断ポイント",
      body:
        "今週は、AIエージェントが単体チャットから業務ツール、デザインキャンバス、開発・セキュリティ実務へ入り込む一方で、実運用に必要な権限管理、検証、ソフトウェア供給網、計算資源の制約が前面に出た。短期では、AI導入の論点を「使うかどうか」ではなく「どの権限で、どの証跡を残し、どの失敗を検知するか」へ移す必要がある。",
      quote:
        "AIエージェント普及の主戦場はモデル性能だけではなく、ワークフロー、権限境界、監査可能性、チップ非依存の実行基盤へ移っている。"
    },
    dashboardMetrics: [
      {
        label: "高優先度",
    ...
    topicCards: [
      {
        ...
        summary:
          "FigmaはConfig 2026で、コードレイヤー、Figma Motion、Shader fills/effects、生成プラグイン、Weave tools、Figma agentのskillsやconnectorsを発表した。コードレイヤーは2026年7月から早期アクセス開始予定。",
        date: "2026-06-24",
        ...
        timing: "すぐ",
        relevance: 94,
        relatedTags: ["AI", "開発者ツール", "エンジニアリング"],
        affected: ["デザイナー", "フロントエンドエンジニア", "プロダクトマネージャー", "デザインシステム担当", "制作会社"],
      ...
      },
      {
        ...
        summary:
          "Qualcommは2026年6月24日、AIソフトウェア企業Modularを買収すると発表した。Modularは異なるチップ環境にAIソフトウェアを展開しやすくする基盤で知られる。",
        date: "2026-06-24",
        ...
        timing: "3か月以内",
        relevance: 91,
        relatedTags: ["半導体", "AI", "開発者ツール"],
        affected: ["AIインフラ企業", "半導体企業", "クラウド事業者", "MLエンジニア", "開発者ツール企業"],
      ...
      },
      {
        ...
        summary:
          "Axiosは、米下院議員Josh Gottheimer氏とJohn Moolenaar氏が、外国主体による高度AI計算のクラウド利用を米商務省へ報告できるようにするCloud Security Actを準備していると報じた。",
        date: "2026-06-26",
        ...
        timing: "3か月以内",
        relevance: 88,
        relatedTags: ["規制", "セキュリティ", "AI"],
        affected: ["クラウド事業者", "AIスタートアップ", "大規模モデル開発企業", "法務・セキュリティ担当", "海外顧客を持つSaaS"],
      ...
      },
      {
        ...
        relevance: 84,
        relatedTags: ["半導体", "AI"],
        affected: ["AIデータセンター", "クラウド事業者", "半導体サプライチェーン", "調達担当", "AIサービス企業"],
      ...
      },
      {
        ...
        summary:
          "arXivの研究は、Ollama上のオープンソースモデルを使ったLLMエージェントをBanditと比較し、現実的条件では既存SASTの代替に適しているとは言いにくいと結論づけた。",
        date: "2026-06-10",
        ...
        timing: "すぐ",
        relevance: 82,
        relatedTags: ["セキュリティ", "AI", "エンジニアリング"],
        affected: ["セキュリティエンジニア", "開発組織", "AIコーディングツール導入担当", "SaaS事業者"],
